...
import com.nix.reference.spring.project.aop.profiling.ExecutionTimeProfiling;
import com.nix.reference.spring.project.aop.profiling.MemoryProfiling;
import com.nix.reference.spring.project.dto.ProductDTO;
import com.nix.reference.spring.project.security.auth.HasManagerRole;
import com.nix.reference.spring.project.service.ProductService;
...
import static com.nix.reference.spring.project.security.auth.Roles.ADMIN_ROLE;
...
public class ProductController {
    ...
    public ProductDTO getProduct(@PathVariable final int id, final @AuthenticationPrincipal UserDetails userDetails) {
        ...
        return new ProductDTO(20, "Tablet", 23.5);
    }
