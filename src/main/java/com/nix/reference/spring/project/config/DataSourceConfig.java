 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.nix.reference.spring.project.domain.repository")
@EnableTransactionManagement
@EntityScan(basePackages = "com.nix.reference.spring.project.domain.model")
