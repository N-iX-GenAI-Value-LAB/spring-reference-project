package com.nix.reference.spring.project.aop.aspect;
...
public class ProfilingAspect {
    ...
    @Around("@annotation(com.nix.reference.spring.project.aop.profiling.ExecutionTimeProfiling)")
    ...
    @Around("@annotation(com.nix.reference.spring.project.aop.profiling.MemoryProfiling)")
